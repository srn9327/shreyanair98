...
def ping(host, timeout=1):
    ...
    delays = array('d', [0.00000000, 0.00000000, 0.00000000, 0.00000000])
    ...
    vars = vars.append({'min': str(round(packet_min, 8)), 'avg': str(round(packet_avg, 8)),
                        'max': str(round(packet_max, 8)), 'stddev': str(round(stdev_var, 8))},
                       ignore_index=True)
    print (vars)
    return vars
